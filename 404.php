...
<head>
    ...
    <title>Seite nicht gefunden – Brumans</title>
    ...
    <main>
        <section class="hero" style="min-height: 60vh; display: flex; align-items: center;">
            <div class="container text-center">
                <h1 style="font-size: var(--font-size-xxl); margin-bottom: var(--spacing-md);">404</h1>
                <p style="font-size: var(--font-size-lg); margin-bottom: var(--spacing-lg);">Diese Seite wurde nicht gefunden.</p>
